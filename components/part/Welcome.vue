    ...
    <div>
        ...
        <Plate color="default" class="plate-with-bold">
            <Typography class="welcome">
                ...
                <br />
                The goal is to make <b>resource creating simpler</b>. You will
                not need to check function types or object properties and
                methods manually. <b>IDE will help</b> you to provide correct
                types and select existing methods. Also you can view
                <b>documentation faster</b> without opening MTA:SA Wiki in
                browser.
            </Typography>
            <Typography class="welcome-center">
                You <b>do not need</b> even <b>to start the game</b> to check
                the syntax. <br />
